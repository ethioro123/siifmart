...
export const POSupplierLogistics: React.FC<POSupplierLogisticsProps> = ({
    ...
    return (
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="relative overflow-hidden rounded-xl p-[1px] group">
                ...
                <div className="relative bg-white dark:bg-black/60 backdrop-blur-xl rounded-xl p-6 h-full border border-gray-200 dark:border-white/5 transition-all hover:bg-gray-50/50 dark:hover:bg-black/50 shadow-sm dark:shadow-none">
                    <div className="absolute top-0 right-0 p-4 opacity-30 group-hover:opacity-100 transition-opacity">
                        <Truck size={20} className="text-blue-600 dark:text-cyber-primary" />
                    </div>

                    <div className="flex items-center gap-3 mb-6 pb-2 border-b border-gray-100 dark:border-white/10">
                        <div className="w-1.5 h-1.5 rounded-full bg-blue-600 dark:bg-cyber-primary shadow-[0_0_8px_rgba(37,99,235,0.4)] dark:shadow-[0_0_8px_rgba(0,255,157,0.8)]"></div>
                    ...
                    <div className="space-y-6">
                        <div className="flex bg-gray-100 dark:bg-black/40 p-1 rounded-lg border border-gray-200 dark:border-white/10">
                            <button
                                ...
                                className={`flex-1 py-1.5 text-[10px] font-black rounded-md transition-all ${!isManualVendor ? 'bg-blue-600 dark:bg-cyber-primary text-white dark:text-black shadow-md dark:shadow-[0_0_15px_rgba(0,255,157,0.4)]' : 'text-gray-500 dark:text-gray-500 hover:text-gray-900 dark:hover:text-gray-300 hover:bg-white dark:hover:bg-white/5'}`}
                            >
                                REGISTERED
                            </button>
                            <button
                        ...
                        {!isManualVendor ? (
                            <div className="space-y-2">
                                ...
                                <div className="relative">
                                    <select
                                        className="w-full bg-gray-50 dark:bg-black/40 border border-gray-200 dark:border-white/10 rounded-lg px-4 py-3 text-sm text-gray-900 dark:text-white focus:border-blue-500/50 dark:focus:border-cyber-primary/50 outline-none transition-all appearance-none cursor-pointer font-bold"
                                        value={newPOSupplier}
            ...
            {/* Logistics Section */}
            <div className="relative overflow-hidden rounded-xl p-[1px] group">
                <div className="absolute inset-0 bg-gradient-to-bl from-purple-500/10 via-transparent to-blue-500/10 dark:from-purple-500/30 dark:via-transparent dark:to-cyber-primary/20 opacity-40"></div>
                <div className="relative bg-white dark:bg-black/60 backdrop-blur-xl rounded-xl p-6 h-full border border-gray-200 dark:border-white/5 transition-all hover:bg-gray-50/50 dark:hover:bg-black/50 shadow-sm dark:shadow-none">
                    <div className="absolute top-0 right-0 p-4 opacity-30 group-hover:opacity-100 transition-opacity">
                    ...
                    <div className="flex items-center gap-3 mb-6 pb-2 border-b border-gray-100 dark:border-white/10">
                        <div className="w-1.5 h-1.5 rounded-full bg-purple-600 dark:bg-purple-500 shadow-[0_0_8px_rgba(147,51,234,0.4)] dark:shadow-[0_0_8px_rgba(168,85,247,0.8)]"></div>
                    ...
                    <div className="space-y-5">
                        ...
                        <div className="space-y-2 relative" ref={siteDropdownRef}>
                            ...
                            <div
                                className={`w-full bg-gray-50 dark:bg-black/40 border rounded-lg px-4 py-3 text-sm text-gray-900 dark:text-white cursor-pointer flex justify-between items-center transition-all ${isSiteDropdownOpen ? 'border-purple-500/50 shadow-[0_0_10px_rgba(168,85,247,0.1)]' : 'border-gray-200 dark:border-white/10 hover:border-gray-300 dark:hover:border-white/20'}`}
                            ...
                            >
                                ...
                                {isSiteDropdownOpen ? <ChevronUp size={16} className="text-purple-600 dark:text-purple-400" /> : <ChevronDown size={16} className="text-gray-400 dark:text-gray-600" />}
                            </div>
                                    ...
                                    {sites.filter(s => s.type === 'Warehouse' || s.type === 'Distribution Center').map(s => (
                                        <div
                                            ...
                                            className={`flex items-center gap-3 p-3 rounded-lg cursor-pointer transition-all ${destinationSiteIds.includes(s.id)
                                                ? 'bg-purple-500/10 text-purple-600 dark:text-white'
                        ...
                        <div className="grid grid-cols-2 gap-4">
                             <div className="space-y-2">
                                ...
                                <input
                                    type="date"
                                    className="w-full bg-gray-50 dark:bg-black/40 border border-gray-200 dark:border-white/10 rounded-lg px-3 py-2 text-xs text-gray-900 dark:text-white focus:border-purple-500/50 outline-none transition-all cursor-text font-bold"
                                    value={expectedDate}
                             ...
                             <div className="space-y-2">
                                ...
                                <div className="relative">
                                    <select
                                        className="w-full bg-gray-50 dark:bg-black/40 border border-gray-200 dark:border-white/10 rounded-lg px-3 py-2 text-xs text-gray-900 dark:text-white focus:border-purple-500/50 outline-none transition-all appearance-none font-bold"
                                        value={poPriority}
                                        onChange={(e) => setPoPriority(e.target.value as any)}
                                        title="Priority"
                                    >
                                        <option value="Low" className="bg-white dark:bg-gray-900">Normal</option>
                                        <option value="Normal" className="bg-white dark:bg-gray-900">Priority</option>
                                        <option value="High" className="bg-white dark:bg-gray-900">Critical</option>
                                        <option value="Urgent" className="bg-white dark:bg-gray-900">Immediate</option>
                                    </select>
                         ...
                         <div className="space-y-2">
                            ...
                            <div className="flex bg-gray-100 dark:bg-black/40 p-1 rounded-lg border border-gray-200 dark:border-white/10">
                                <button
                                    ...
                                    className={`flex-1 py-1.5 text-[9px] font-black rounded transition-all ${quantityDistribution === 'per-store' ? 'bg-white dark:bg-purple-500/20 text-purple-600 dark:text-purple-300 border border-gray-200 dark:border-purple-500/30 shadow-sm dark:shadow-[0_0_10px_rgba(168,85,247,0.1)]' : 'text-gray-500 dark:text-gray-500 hover:text-gray-900 dark:hover:text-gray-300'}`}
                                >
                                    PER NODE
                                </button>
                                <button
                                    onClick={() => setQuantityDistribution('total-split')}
                                    className={`flex-1 py-1.5 text-[9px] font-black rounded transition-all ${quantityDistribution === 'total-split' ? 'bg-white dark:bg-purple-500/20 text-purple-600 dark:text-purple-300 border border-gray-200 dark:border-purple-500/30 shadow-sm dark:shadow-[0_0_10px_rgba(168,85,247,0.1)]' : 'text-gray-500 dark:text-gray-500 hover:text-gray-900 dark:hover:text-gray-300'}`}
                                >
                                    AUTO SPLIT
                                </button>
                            </div>
