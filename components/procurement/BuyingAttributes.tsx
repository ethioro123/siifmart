...
export const BuyingAttributes: React.FC<BuyingAttributesProps> = ({
    ...
    return (
        <div className="space-y-4">
            {/* ─── HEADER ──────────────────────────────────── */}
            <div className="flex items-center gap-2 pb-2 border-b border-blue-600/20 dark:border-blue-500/20">
                <div className="w-1.5 h-1.5 rounded-full bg-blue-600 dark:bg-blue-400 shadow-[0_0_8px_rgba(37,99,235,0.4)] dark:shadow-[0_0_8px_rgba(96,165,250,0.4)]" />
                <span className="text-[10px] text-blue-600 dark:text-blue-400 font-black uppercase tracking-[0.2em]">Product & Procurement</span>
            </div>

            <div className="relative overflow-hidden rounded-xl p-[1px]">
                <div className="absolute inset-0 bg-gradient-to-br from-blue-500/10 via-transparent to-cyan-500/10 dark:from-blue-500/20 dark:via-transparent dark:to-cyan-500/20 opacity-30" />
                <div className="relative bg-white dark:bg-black/60 backdrop-blur-xl rounded-xl p-5 space-y-5 border border-gray-100 dark:border-white/5 shadow-sm dark:shadow-none">

                    {/* ── Identity ──────────────────────────────── */}
                    <div className="grid grid-cols-6 gap-4">
                        <div className="col-span-2 space-y-1">
                            <label className="text-[10px] text-gray-500 dark:text-gray-400 uppercase font-black ml-1">Brand <span className="text-blue-600 dark:text-blue-400">*</span></label>
                            <input type="text" className={`w-full bg-gray-50 dark:bg-black/40 border ${errors.brand ? 'border-red-500/50' : 'border-gray-200 dark:border-white/10'} rounded-lg px-3 py-2 text-xs text-gray-900 dark:text-white focus:border-blue-500/50 dark:focus:border-blue-400/50 outline-none transition-all placeholder-gray-400 dark:placeholder-gray-600 font-bold`} placeholder="Brand Name" value={customItemBrand} onChange={e => { setCustomItemBrand(e.target.value); if (errors.brand) setErrors(p => ({ ...p, brand: '' })); }} />
                            {errors.brand && <span className="text-[9px] text-red-500 ml-1 font-bold">{errors.brand}</span>}
                        </div>
                        <div className="col-span-4 space-y-1">
                            <label className="text-[10px] text-gray-500 dark:text-gray-400 uppercase font-black ml-1">Product Name <span className="text-blue-600 dark:text-blue-400">*</span></label>
                            <input type="text" className={`w-full bg-gray-50 dark:bg-black/40 border ${errors.name ? 'border-red-500/50' : 'border-gray-200 dark:border-white/10'} rounded-lg px-3 py-2 text-sm text-gray-900 dark:text-white font-black focus:border-blue-500/50 dark:focus:border-blue-400/50 outline-none transition-all placeholder-gray-400 dark:placeholder-gray-600`} placeholder="Product Name" value={customItemName} onChange={e => { setCustomItemName(e.target.value); if (errors.name) setErrors(p => ({ ...p, name: '' })); }} />
                    ...
                    <div className="grid grid-cols-6 gap-4">
                        <div className="col-span-2 space-y-1">
                            <label className="text-[10px] text-gray-500 dark:text-gray-400 uppercase font-black ml-1">Category <span className="text-blue-600 dark:text-blue-400">*</span></label>
                            <div className="relative">
                                <select title="Category" className={`w-full bg-gray-50 dark:bg-black/40 border ${errors.category ? 'border-red-500/50' : 'border-gray-200 dark:border-white/10'} rounded-lg px-3 py-2 text-xs text-gray-900 dark:text-white focus:border-blue-500/50 dark:focus:border-blue-400/50 outline-none appearance-none font-bold`} value={selectedMainCategory} onChange={e => { setSelectedMainCategory(e.target.value); if (errors.category) setErrors(p => ({ ...p, category: '' })); }}>
                        ...
                        <div className="col-span-2 space-y-1">
                            ...
                            <input type="text" className="w-full bg-gray-50 dark:bg-black/40 border border-gray-200 dark:border-white/10 rounded-lg px-3 py-2 text-xs text-gray-900 dark:text-white focus:border-blue-500/50 dark:focus:border-blue-400/50 outline-none transition-all placeholder-gray-400 dark:placeholder-gray-600 font-bold" placeholder="e.g. Organic" value={customAttributes.identity.subcategory} onChange={e => setCustomAttributes((p: any) => ({ ...p, identity: { ...p.identity, subcategory: e.target.value } }))} />
                        </div>
                        <div className="col-span-2 space-y-1">
                    ...
                    <div className="grid grid-cols-6 gap-4 pt-3 border-t border-gray-100 dark:border-white/5">
                        ...
                        <div className="col-span-2 space-y-1">
                            <label className="text-[10px] text-gray-500 dark:text-gray-400 uppercase font-black ml-1">Size <span className="text-blue-600 dark:text-blue-400">*</span></label>
                            <div className="flex gap-1">
                                <input
                                    ...
                                    title="Size value"
                                    placeholder="e.g. 500"
                                    className={`w-full bg-gray-50 dark:bg-black/40 border ${errors.size ? 'border-red-500/50' : 'border-gray-200 dark:border-white/10'} rounded-l-lg px-3 py-2 text-xs text-gray-900 dark:text-white focus:border-blue-500/50 dark:focus:border-blue-400/50 outline-none transition-all placeholder-gray-400 dark:placeholder-gray-600 font-bold`}
                                ...
                                <div className="relative min-w-[60px]">
                                    <select
                                        title="Size Type"
                                        className={`w-full h-full bg-gray-100 dark:bg-black/40 border ${errors.size && !sizeType ? 'border-red-500/50' : 'border-gray-200 dark:border-white/10'} rounded-r-lg px-2 py-2 text-xs text-gray-900 dark:text-white focus:border-blue-500/50 dark:focus:border-blue-400/50 outline-none appearance-none font-black text-center`}
                                        value={sizeType}
                                        onChange={e => {
                        ...
                        <div className="col-span-2 space-y-1">
                            ...
                            <div className="relative">
                                <select title="Package Type" className="w-full bg-gray-50 dark:bg-black/40 border border-gray-200 dark:border-white/10 rounded-lg px-3 py-2 text-xs text-gray-900 dark:text-white focus:border-blue-500/50 dark:focus:border-blue-400/50 outline-none appearance-none font-bold" value={customAttributes.packaging.packageType} onChange={e => setCustomAttributes((p: any) => ({ ...p, packaging: { ...p.packaging, packageType: e.target.value } }))}>
                                    <option value="" className="bg-white dark:bg-gray-900 text-gray-500">Select...</option>
                        ...
                        <div className="col-span-2 flex items-end pb-1">
                            <label className="flex items-center gap-2 cursor-pointer group">
                                <input
                                    type="checkbox"
                                    className="w-3 h-3 rounded border-gray-300 dark:border-white/10 bg-gray-50 dark:bg-black/40 text-blue-600 dark:text-blue-400"
                                ...
                                />
                                <span className="text-[10px] text-gray-500 dark:text-gray-400 group-hover:text-blue-600 dark:group-hover:text-blue-300 transition-colors font-black uppercase tracking-tight">Ships in packs / cases</span>
                            </label>
                        </div>
                    </div>
                    ...
                    {((parseInt(customAttributes.packaging.packQty) > 1) || (parseInt(customAttributes.packaging.caseSize) > 0)) && (
                        <div className="grid grid-cols-6 gap-4 pl-4 border-l-2 border-blue-200 dark:border-blue-500/20">
                            <div className="col-span-3 space-y-1">
                                ...
                                <input type="number" min="2" className="w-full bg-gray-50 dark:bg-black/40 border border-blue-100 dark:border-blue-500/20 rounded-lg px-3 py-2 text-xs text-gray-900 dark:text-white focus:border-blue-500/50 dark:focus:border-blue-400/50 outline-none transition-all placeholder-gray-400 dark:placeholder-gray-600 font-bold" placeholder="e.g. 6" value={customAttributes.packaging.packQty} onChange={e => setCustomAttributes((p: any) => ({ ...p, packaging: { ...p.packaging, packQty: e.target.value } }))} />
                            </div>
                            <div className="col-span-3 space-y-1">
                                ...
                                <input type="number" min="1" className="w-full bg-gray-50 dark:bg-black/40 border border-blue-100 dark:border-blue-500/20 rounded-lg px-3 py-2 text-xs text-gray-900 dark:text-white focus:border-blue-500/50 dark:focus:border-blue-400/50 outline-none transition-all placeholder-gray-400 dark:placeholder-gray-600 font-bold" placeholder="e.g. 24" value={customAttributes.packaging.caseSize || ''} onChange={e => setCustomAttributes((p: any) => ({ ...p, packaging: { ...p.packaging, caseSize: e.target.value } }))} />
                            </div>
                        </div>
                    )}
                    ...
                    <div className="grid grid-cols-6 gap-4 pt-3 border-t border-gray-100 dark:border-white/5">
                        ...
                        <div className="col-span-1 space-y-1">
                            ...
                            <div className="flex gap-1">
                                <input type="number" min="0" className="w-full bg-gray-50 dark:bg-black/40 border border-gray-200 dark:border-white/10 rounded-lg px-2 py-2 text-xs text-gray-900 dark:text-white focus:border-blue-500/50 dark:focus:border-blue-400/50 outline-none transition-all placeholder-gray-400 dark:placeholder-gray-600 text-center font-bold" placeholder="--" value={customAttributes.storage.shelfLifeDays || ''} onChange={e => setCustomAttributes((p: any) => ({ ...p, storage: { ...p.storage, shelfLifeDays: e.target.value } }))} />
                        ...
                        <div className="col-span-1 flex flex-col justify-end gap-2 pb-1">
                            <label className="flex items-center gap-1.5 cursor-pointer group">
                                <input type="checkbox" className="w-3 h-3 rounded border-gray-300 dark:border-white/10 bg-gray-50 dark:bg-black/40 text-blue-600 dark:text-blue-400" checked={customAttributes.packaging.isBreakable} onChange={e => setCustomAttributes((p: any) => ({ ...p, packaging: { ...p.packaging, isBreakable: e.target.checked } }))} />
                                <span className="text-[10px] text-gray-500 dark:text-gray-400 group-hover:text-blue-600 dark:group-hover:text-blue-300 transition-colors font-black uppercase tracking-tight">Breakable</span>
                            </label>
                        </div>
                    </div>
                    ...
                    <div className="flex flex-wrap gap-5 pt-2 border-t border-gray-100 dark:border-white/5">
                        <label className="flex items-center gap-1.5 cursor-pointer group">
                            <input type="checkbox" className="w-3 h-3 rounded border-gray-300 dark:border-white/10 bg-gray-100 dark:bg-black/40 text-blue-600 dark:text-blue-400" checked={customAttributes.storage.isLightSensitive} onChange={e => setCustomAttributes((p: any) => ({ ...p, storage: { ...p.storage, isLightSensitive: e.target.checked } }))} />
                            <span className="text-[10px] text-gray-500 dark:text-gray-400 group-hover:text-blue-600 dark:group-hover:text-blue-300 transition-colors font-black uppercase tracking-tight">Light Sensitive</span>
                        </label>
                        <label className="flex items-center gap-1.5 cursor-pointer group">
