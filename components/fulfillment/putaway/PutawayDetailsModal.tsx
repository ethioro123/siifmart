...
export const PutawayDetailsModal: React.FC<PutawayDetailsModalProps> = ({
    ...
    return (
        <div className="fixed inset-0 bg-gray-900/40 dark:bg-black/80 backdrop-blur-sm flex items-stretch md:items-center justify-center z-[200] p-0 md:p-4 animate-in fade-in duration-300">
            <div className="bg-white dark:bg-black md:border-2 border-[#E2DCCE]/60 dark:border-white/10 md:rounded-[2.5rem] w-full md:max-w-2xl shadow-2xl flex flex-col h-full md:h-auto md:max-h-[92vh] overflow-hidden relative transition-all">
                {/* Visual Flair */}
                ...
                {/* Header */}
                <div className="p-6 md:p-8 border-b border-[#E2DCCE]/60 dark:border-white/10 flex justify-between items-start bg-[#FAF8F5]/50 dark:bg-zinc-950/50 backdrop-blur-md relative z-10">
                    <div className="flex gap-5">
                        <div className="hidden md:flex p-4 rounded-2xl border border-[#E2DCCE]/60 dark:border-[#2C5E3B]/30 bg-[#2C5E3B]/10 dark:bg-[#2C5E3B]/20 text-[#2C5E3B] dark:text-[#A9CBA2] shadow-sm transition-all duration-500 active:scale-95">
