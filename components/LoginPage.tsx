...
const QUICK_ACCOUNTS = [
  ...
  { name: 'Sara Tesfaye', role: 'System Admin', email: 'sara.tesfaye@siifmart.com', password: 'siif123' },
  { name: 'Tigist Alemayehu', role: 'HR Manager', email: 'tigist.alemayehu@siifmart.com', password: 'siif123' },
  { name: 'Rahel Tesfaye', role: 'Finance Manager', email: 'rahel.tesfaye@siifmart.com', password: 'siif123' },
  { name: 'Yohannes Bekele', role: 'Procurement Mgr', email: 'yohannes.bekele@siifmart.com', password: 'siif123' },
  { name: 'Dawit Haile', role: 'Auditor', email: 'dawit.haile@siifmart.com', password: 'siif123' },
  { name: 'Elias Kebede', role: 'IT Support', email: 'elias.kebede@siifmart.com', password: 'siif123' },
  { name: 'Kamal Idriss', role: 'Warehouse Mgr (Harar)', email: 'siif-0034@siifmart.com', password: 'siif123' },
  { name: 'Lensa Merga', role: 'Warehouse Mgr (HQ)', email: 'lensa.merga@siifmart.com', password: 'siif123' },
  ...
  { name: 'Abdi Rahman', role: 'Store Manager', email: 'abdi.rahman@siifmart.com', password: 'siif123' },
  { name: 'Sara Bekele', role: 'Shift Lead', email: 'sara.bekele@siifmart.com', password: 'siif123' },
  { name: 'Tomas Tesfaye', role: 'Cashier / POS', email: 'tomas.tesfaye@siifmart.com', password: 'siif123' }
];
  ...
  return (
    <div className="min-h-screen w-full flex items-center justify-center p-4 relative overflow-hidden bg-gradient-to-br from-[#FAF8F5] via-[#F4F0E6] to-[#FAF8F5] dark:from-[#0B0F0D] dark:via-[#131915] dark:to-[#0B0F0D] transition-colors duration-500">
      ...
      <div className="max-w-[440px] w-full bg-white/85 dark:bg-[#18201B]/60 border border-[#E2DCCE] dark:border-emerald-950/20 rounded-[32px] p-8 sm:p-10 relative z-10 shadow-[0_24px_80px_-12px_rgba(34,50,38,0.06)] dark:shadow-[0_32px_96px_-12px_rgba(5,8,6,0.65)] lg:backdrop-blur-2xl transition-all duration-300">
        ...
        {/* Localhost Quick Sign-In Panel (ONLY visible on localhost) */}
        {isLocalhost && mode === 'login' && (
          <div className="mt-6 pt-6 border-t border-[#E2DCCE]/40 dark:border-white/[0.04]">
            ...
            >
              <span>Localhost Quick Login</span>
        ...
        <div className="mt-8 pt-6 border-t border-[#E2DCCE]/40 dark:border-white/[0.04] text-center select-none">
          <p className="text-[10px] text-[#4D6E56] dark:text-[#7A9E83] font-semibold tracking-wider uppercase">SiifMart Operations v3.5.1</p>
        </div>
      </div>
    </div>
  );
