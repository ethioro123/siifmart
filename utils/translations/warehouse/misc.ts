...
export const misc: TranslationBlock = {
    ...
    allItemsProcessed: { en: 'All items processed.', am: 'ሁሉም ዕቃዎች ተካሂደዋል።', or: 'Meeshaleen hundi adeemaniiru.' },
    ...
    chooseWhereToStore: { en: 'Choose where to store this item', am: 'ይህንን ዕቃ የት እንደሚያከማቹ ይምረጡ', or: 'Meesha kana eessa kuusuu akka barbaadan filadhu' },
    chooseWhereToPick: { en: 'Choose where to pick this item', am: 'ይህንን ዕቃ የት እንደሚወስዱ ይምረጡ', or: 'Meesha kana eessa fudhatuu akka barbaadan filadhu' },
    ...
    skipItem: { en: 'SKIP ITEM', am: 'ዕቃ ዝለል', or: 'MEESHA DABALSI' },
    ...
    itemSkipped: { en: 'Item skipped. Moved to end of pick list.', am: 'ዕቃ ተዘልሏል። ወደ የመምረጫ ዝርዝር መጨረሻ ተዛውሯል።', or: 'Meeshaan dabalameera. Gara booda tarree filannoo geessameera.' },
    ...
    errorJobNoItems: { en: 'Error: Job has no items. Please contact IT.', am: 'ስህተት: ስራው ዕቃዎች የሉትም። እባክዎ IT ያግኙ።', or: 'Dogoggora: Hojii kana keessatti meeshaleen hin jiru. Maaloo IT qunnamti.' },
    ...
    itemsLabel: { en: 'Items', am: 'ዕቃዎች', or: 'Meeshalee' },
