...
> All AI assistants working on this project MUST follow these rules. Full details in `.agent/RULES.md`.
...
- ❌ Don't push without incrementing version in LoginPage.tsx
